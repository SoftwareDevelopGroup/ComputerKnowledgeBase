...
>
> 本课程在 电路与模拟电子技术（半导体器件、门电路底层原理）之后展开：把模拟电子的"连续信号放大"转为"离散信号处理"，把晶体管的"线性工作区"转为"开关工作状态"。本课程是后续计算机组成原理、微机原理、嵌入式系统的直接先修。
...
- **先修**：电路与模拟电子技术（半导体器件、PN 结、三极管开关特性为门电路基础）、大学物理B（电磁学基础）
