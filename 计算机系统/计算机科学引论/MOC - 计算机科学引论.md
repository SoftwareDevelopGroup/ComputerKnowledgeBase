...
> [!info] 网络方向深入入口
> 计算机网络把引论中的“连接”主题扩展为完整课程体系：从物理信号、帧与 IP 转发，继续到 TCP/UDP、应用协议、网络安全、多媒体和无线移动网络。

> [!info] 操作系统方向深入入口
> 操作系统把引论中的“平台”主题展开为完整课程体系：由系统调用连接应用与内核，以进程、线程和调度组织执行，以虚拟内存和文件系统管理状态，并用保护与安全机制约束资源访问。

> [!info] 数据结构与算法方向深入入口
> 数据结构把引论中的“数据与算法”主题展开为完整课程体系：从逻辑结构、存储结构与抽象数据类型出发，继续到线性表、树、图、查找、排序及其时间与空间复杂度。
...
| 5. 学会“构造”    | 如何把需求转化为可维护的软件？  | [[13-编程与语言]]、数据结构、[[12-系统分析与设计]]              |
